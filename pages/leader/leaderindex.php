...
<div class="container my-3 bg-white p-4 rounded">
    ...
    <p class="cub-scouts-overview"><img src="assets/Images/symbol.png" class="icon">Weekly meetings occur at various venues like schools, church halls, community centers, or dedicated Scout headquarters. These gatherings, known as the Beaver Scout Colony, are designed to be both fun and educational.</p>
    <p>The Cub Scout program is rich with exciting activities and adventures, aimed at presenting challenges and prepping them for the Scout stage. Cub Scouts can earn up to 7 'challenge' badges and 33 'activity' badges. They also have opportunities for weekend camping trips and participate in district-led activities and various excursions to attractions like theme parks and zoos.</p> <div class="border"></div>



    <h3 class="mb-3">Badge Activities</h3>
    <p class="cub-scouts-overview"><img src="assets/Images/symbol.png" class="icon">Our activity badges enable Cub Scouts to demonstrate their skills in current hobbies and discover new ones. These badges are designed to motivate young Scouts to broaden their interests and talents.</p> <div class="border"></div>

    <h3 class="mb-3">Achievement Challenges</h3>
    <p class="cub-scouts-overview"><img src="assets/Images/symbol.png" class="icon">Challenge Awards require more effort and may involve completing tasks within the group, community, or at home. These awards span themes such as physical activity, outdoor skills, and community service, encouraging young people to push their boundaries and achieve significant milestones.</p> <div class="border"></div>

    <h3 class="mb-3">Resourceful Packs</h3>
    <p class="cub-scouts-overview"><img src="assets/Images/symbol.png" class="icon">Several activity badges are supported by external organizations that provide resource packs, guiding young Scouts through the badge requirements and helping them track their progress.</p> <div class="border"></div>

    <h3 class="mb-3">Top Honor: Chief Scout's Award</h3>
    <p class="cub-scouts-overview"><img src="assets/Images/symbol.png" class="icon">The Chief Scout's Silver Award is the highest recognition for Cub Scouts. To achieve this, a Cub Scout must complete six Challenge Awards before advancing to the Scout section. This prestigious award can also be completed early in their Scout journey if needed, symbolizing a major achievement and readiness for future challenges.</p> <div class="border"></div>
</div>
<div class="container section-title">
    <h2>Testimonials</h2>
</div>
<!-- Carousel wrapper -->
<div id="carousel" data-mdb-carousel-init class="carousel slide carousel-dark text-center-carousel" data-mdb-ride="carousel">
  <!-- Inner -->
      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-4">
            ...
            src="assets/Images/carousel/boy.jpg" alt="avatar"
              style="width: 150px;" />
          ...
          <div class="col-lg-4 d-none d-lg-block">
            <img class="rounded-circle shadow-1-strong mb-4"
            src="assets/Images/carousel/man.jpg" alt="avatar"
              style="width: 150px;" />
          ...
          <div class="col-lg-4 d-none d-lg-block">
            <img class="rounded-circle shadow-1-strong mb-4"
            src="assets/Images/carousel/woman.jpg" alt="avatar"
              style="width: 150px;" />
    ...
    <div class="carousel-item">
      <div class="container">
        <div class="row">
          <div class="col-lg-4">
            <img class="rounded-circle shadow-1-strong mb-4"
            src="assets/Images/carousel/man1.jpg" alt="avatar"
              style="width: 150px;" />
          ...
          <div class="col-lg-4 d-none d-lg-block">
            <img class="rounded-circle shadow-1-strong mb-4"
            src="assets/Images/carousel/girl.jpg" alt="avatar"
              style="width: 150px;" />
          ...
          <div class="col-lg-4 d-none d-lg-block">
            <img class="rounded-circle shadow-1-strong mb-4"
            src="assets/Images/carousel/woman1.jpg" alt="avatar"
              style="width: 150px;" />
    ...
    <div class="carousel-item">
      <div class="container">
        <div class="row">
          <div class="col-lg-4">
            <img class="rounded-circle shadow-1-strong mb-4"
            src="assets/Images/carousel/man2.jpg" alt="avatar"
              style="width: 150px;" />
          ...
          <div class="col-lg-4 d-none d-lg-block">
            <img class="rounded-circle shadow-1-strong mb-4"
            src="assets/Images/carousel/woman2.jpg" alt="avatar"
              style="width: 150px;" />
          ...
          <div class="col-lg-4 d-none d-lg-block">
            <img class="rounded-circle shadow-1-strong mb-4"
            src="assets/Images/carousel/woman3.jpg" alt="avatar"
              style="width: 150px;" />
  ...
  <button data-mdb-button-init class="carousel-control-prev" type="button" data-mdb-target="#carousel"
    data-mdb-slide="prev">
    <span class="carousel-control-prev-icon text-body" aria-hidden="true"></span>
    <span class="visually-hidden">Previous</span>
  </button>
  <button data-mdb-button-init class="carousel-control-next" type="button" data-mdb-target="#carousel"
    data-mdb-slide="next">
