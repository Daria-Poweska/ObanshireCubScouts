    ...
    <div class="container">
      ...
      <div class="row">
        ...
        <div class="col-lg-4 col-md-6 badges">
          <div class="card">
            <img src="assets/Images/badges/artist.png" class="card-img-top" alt="Artist Badge" />
            <div class="card-body d-flex flex-column">
              ...
              <div class="read-more mt-auto">
                <button class="btn-join-us-square events" data-bs-toggle="modal" data-bs-target="#artistModal">Read More</button>
              </div>
            </div>
          </div>
        </div>
            ...
            <div class="modal-content">
              ...
              <div class="modal-body d-flex flex-column">
                <div class="d-flex flex-column flex-md-row align-items-center mb-3">
                  <img src="assets/Images/badges/artist.png" class="img-fluid me-md-3 mb-3 mb-md-0" alt="Artist Badge" style="max-width: 150px;" />
              ...
              <div class="modal-footer">
                <div class="read-more">
                  <button type="button" class="btn-join-us-square events" data-bs-dismiss="modal">Go Back</button>
                </div>
              </div>
            </div>
          </div>
        ...
        <div class="col-lg-4 col-md-6 badges">
          <div class="card">
            <img src="assets/Images/badges/astronautics.png" class="card-img-top" alt="Astronautics Badge" />
            <div class="card-body d-flex flex-column">
              ...
              <div class="read-more mt-auto">
                <button class="btn-join-us-square events" data-bs-toggle="modal" data-bs-target="#astronauticsModal">Read More</button>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="modal fade" id="astronauticsModal" tabindex="-1" aria-labelledby="astronauticsModalLabel" aria-hidden="true">
          <div class="modal-dialog modal-dialog-centered modal-lg">
            <div class="modal-content">
              ...
              <div class="modal-body d-flex flex-column">
                <div class="d-flex flex-column flex-md-row align-items-center mb-3">
                  <img src="assets/Images/badges/astronautics.png" class="img-fluid me-md-3 mb-3 mb-md-0" alt="Astronautics Badge" style="max-width: 150px;" />
        ...
        <div class="col-lg-4 col-md-6 badges">
          <div class="card">
            <img src="assets/Images/badges/astronomics.png" class="card-img-top" alt="Astronomer Activity Badge" />
            <div class="card-body d-flex flex-column">
              ...
              <div class="read-more mt-auto">
                <button class="btn-join-us-square events" data-bs-toggle="modal" data-bs-target="#astronomerModal">Read More</button>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="modal fade" id="astronomerModal" tabindex="-1" aria-labelledby="astronomerModalLabel" aria-hidden="true">
          <div class="modal-dialog modal-dialog-centered modal-lg">
            <div class="modal-content">
              ...
              <div class="modal-body d-flex flex-column">
                <div class="d-flex flex-column flex-md-row align-items-center mb-3">
                  <img src="assets/Images/badges/astronomics.png" class="img-fluid me-md-3 mb-3 mb-md-0" alt="Astronomer Activity Badge" style="max-width: 150px;" />
        ...
        <!-- Card: Communicator Badge -->
        <div class="col-lg-4 col-md-6 badges">
          <div class="card">
            <img src="assets/Images/badges/communicator.png" class="card-img-top" alt="Communicator Badge" />
            <div class="card-body d-flex flex-column">
              ...
              <div class="read-more mt-auto">
                <button class="btn-join-us-square events" data-bs-toggle="modal" data-bs-target="#communicatorModal">Read More</button>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="modal fade" id="communicatorModal" tabindex="-1" aria-labelledby="communicatorModalLabel" aria-hidden="true">
          <div class="modal-dialog modal-dialog-centered modal-lg">
            <div class="modal-content">
              ...
              <div class="modal-body d-flex flex-column">
                <div class="d-flex flex-column flex-md-row align-items-center mb-3">
                  <img src="assets/Images/badges/communicator.png" class="img-fluid me-md-3 mb-3 mb-md-0" alt="Communicator Badge" style="max-width: 150px;" />
        ...
        <div class="col-lg-4 col-md-6 badges">
          <div class="card">
            <img src="assets/Images/badges/craft.png" class="card-img-top" alt="Craft Badge" />
            <div class="card-body d-flex flex-column">
              ...
              <div class="read-more mt-auto">
                <button class="btn-join-us-square events" data-bs-toggle="modal" data-bs-target="#craftModal">Read More</button>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="modal fade" id="craftModal" tabindex="-1" aria-labelledby="craftModalLabel" aria-hidden="true">
          <div class="modal-dialog modal-dialog-centered modal-lg">
            <div class="modal-content">
              ...
              <div class="modal-body d-flex flex-column">
                <div class="d-flex flex-column flex-md-row align-items-center mb-3">
                  <img src="assets/Images/badges/craft.png" class="img-fluid me-md-3 mb-3 mb-md-0" alt="Craft Badge" style="max-width: 150px;" />
        ...
        <div class="col-lg-4 col-md-6 badges">
          <div class="card">
            <img src="assets/Images/badges/diy.png" class="card-img-top" alt="DIY Badge" />
            <div class="card-body d-flex flex-column">
              ...
              <div class="read-more mt-auto">
                <button class="btn-join-us-square events" data-bs-toggle="modal" data-bs-target="#diyModal">Read More</button>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="modal fade" id="diyModal" tabindex="-1" aria-labelledby="diyModalLabel" aria-hidden="true">
          <div class="modal-dialog modal-dialog-centered modal-lg">
            <div class="modal-content">
              ...
              <div class="modal-body d-flex flex-column">
                <div class="d-flex flex-column flex-md-row align-items-center mb-3">
                  <img src="assets/Images/badges/diy.png" class="img-fluid me-md-3 mb-3 mb-md-0" alt="DIY Badge" style="max-width: 150px;" />
        ...
        <div class="col-lg-4 col-md-6 badges">
          <div class="card">
            ...
            <div class="card-body d-flex flex-column">
              ...
              <div class="read-more mt-auto">
                <button class="btn-join-us-square events" data-bs-toggle="modal" data-bs-target="#entertainerModal">Read More</button>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="modal fade" id="entertainerModal" tabindex="-1" aria-labelledby="entertainerModalLabel" aria-hidden="true">
          <div class="modal-dialog modal-dialog-centered modal-lg">
            <div class="modal-content">
              ...
              <div class="modal-body d-flex flex-column">
                <div class="d-flex flex-column flex-md-row align-items-center mb-3">
                  <img src="assets/Images/badges/entertainer.png" class="img-fluid me-md-3 mb-3 mb-md-0" alt="Entertainer Badge" style="max-width: 150px;" />
        ...
        <div class="col-lg-4 col-md-6 badges">
          <div class="card">
            <img src="assets/Images/badges/farming.png" class="card-img-top" alt="Farming Badge" />
            <div class="card-body d-flex flex-column">
              ...
              <div class="read-more mt-auto">
                <button class="btn-join-us-square events" data-bs-toggle="modal" data-bs-target="#farmingModal">Read More</button>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="modal fade" id="farmingModal" tabindex="-1" aria-labelledby="farmingModalLabel" aria-hidden="true">
          <div class="modal-dialog modal-dialog-centered modal-lg">
            <div class="modal-content">
              ...
              <div class="modal-body d-flex flex-column">
                <div class="d-flex flex-column flex-md-row align-items-center mb-3">
                  <img src="assets/Images/badges/farming.png" class="img-fluid me-md-3 mb-3 mb-md-0" alt="Farming Badge" style="max-width: 150px;" />
        ...
        <div class="col-lg-4 col-md-6 badges">
          <div class="card">
            <img src="assets/Images/badges/cyclist.png" class="card-img-top" alt="Cyclist Badge" />
            <div class="card-body d-flex flex-column">
              ...
              <div class="read-more mt-auto">
                <button class="btn-join-us-square events" data-bs-toggle="modal" data-bs-target="#cyclistModal">Read More</button>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="modal fade" id="cyclistModal" tabindex="-1" aria-labelledby="cyclistModalLabel" aria-hidden="true">
          <div class="modal-dialog modal-dialog-centered modal-lg">
            <div class="modal-content">
              ...
              <div class="modal-body d-flex flex-column">
                <div class="d-flex flex-column flex-md-row align-items-center mb-3">
                  <img src="assets/Images/badges/cyclist.png" class="img-fluid me-md-3 mb-3 mb-md-0" alt="Cyclist Badge" style="max-width: 150px;" />
        ...
        <div class="col-lg-4 col-md-6 badges">
          <div class="card">
            ...
            <div class="card-body d-flex flex-column">
              ...
              <div class="read-more mt-auto">
                <button class="btn-join-us-square events" data-bs-toggle="modal" data-bs-target="#ecoExplorerModal">Read More</button>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="modal fade" id="ecoExplorerModal" tabindex="-1" aria-labelledby="ecoExplorerModalLabel" aria-hidden="true">
          <div class="modal-dialog modal-dialog-centered modal-lg">
            <div class="modal-content">
              ...
              <div class="modal-body d-flex flex-column">
                <div class="d-flex flex-column flex-md-row align-items-center mb-3">
                  <img src="assets/Images/badges/environmental.png" class="img-fluid me-md-3 mb-3 mb-md-0" alt="Eco-Explorer Badge" style="max-width: 150px;" />
                  <p class="textmodal" data-card-title="Eco-Explorer Badge">
                    This badge encourages scouts to explore and understand the diverse ecosystems found in their local area and beyond. Through hands-on activities and field trips, scouts will gain a deeper appreciation for the natural world and learn how to minimize their environmental impact.
                  </p>
                </div>
              </div>
              <div class="modal-footer">
        ...
        <div class="col-lg-4 col-md-6 badges">
          <div class="card">
            ...
            <div class="card-body d-flex flex-column">
              ...
              <div class="read-more mt-auto">
                <button class="btn-join-us-square events" data-bs-toggle="modal" data-bs-target="#fireModal">Read More</button>
              </div>
            </div>
          </div>
        </div>
