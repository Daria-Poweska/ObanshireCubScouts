<?php include '../../account/config/config.php';
session_start();
include '../../partials/leaderheader.php';
include '../../partials/navbarforlogged.php';

// Checking if user is a helper or a scout
...
// Handling the picture submission
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['submit'])) {
    ...
    if (isset($_SESSION['user_id'])) {
        ...
        // Checking if user_id exists in the users table
